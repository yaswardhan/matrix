...
{
   if($fgmembersite->AddEditProjectDetails())
   {
...
<div class='container' align="left">
    ...
    <input type='text' name='ProjectName' id='ProjectName' value='<?php echo $fgmembersite->SafeDisplay('ProjectName') ?>' maxlength="50" /><br/>
</div>
<div class='container' align="left">
...
<div class='container' align="left">
    <label for='IT' >Select IT Team Member :  </label> 
...
<div class='container'>
    ...
    <textarea name='ProjectSpecification' rows="3" id='ProjectSpecification' style='width:400px; max-width:400px; min-width:400px'> </textarea><br/>
</div>
