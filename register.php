...
<div class='container'>
  ...
  <!--  <input type='text' name='user_type' id='user_type' value='<?php echo $fgmembersite->SafeDisplay('user_type') ?>' maxlength="50" />-->
  ...
  ?>
    ...
    <span id='register_user_type_errorloc' class='error'></span>
</div>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("user_type","req","Please provide usertype");
